        ...
        <div class="row">
            ...
            <div class="col s3 m3 l10" style="margin-left: 300px; margin-right: 300px;">
                <div class="col l8 card">
                    <h5 class="center">Pesquisa de coordenadors</h5>
                    <div class="col l12">
                        <table>
                            <tr>
                                <td>
                    ...
                    <div id="tabela" class="loader">
                        ...
                        <table class="striped">
                            ...
                            <?php
                            include_once '../Controle/coordenadorPDO.php';
                            include_once '../Modelo/coordenador.php';
                            $coordenadorListar = new coordenadorPDO();
                            if (isset($_POST['pesquisar'])) {
                                $pesquisa = $_POST['pesquisar'];
                                $metodo = $_POST['select'];
                                $sql = $coordenadorListar->$metodo($pesquisa);
                            } else {
                                $sql = $coordenadorListar->selectCoordenador();
                            }
                            if ($sql != false) {

                                while ($resultado = $sql->fetch()) {
                                    $tr = new coordenador($resultado);
                                    echo "<tr>";
                                    echo "<td>" . $tr->getMatricula() . "</td>";
                                    echo "<td>" . $tr->getTelefone() . "</td>";
                                    echo "<td>" . $tr->getFoto() . "</td>";

//                        -----------------------------------------------------------

//                                           echo "<td>";
//                                           ?><!--<a class="btn corpadrao" href="./verMais.php?id=<?php // echo $tr->getId_coordenador(); ?>">Ver mais</a>--><?php
//                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
