...
<main>
    <div class="row center">
        <div class="card z-depth-3 col s12 m12 l10 offset-l1">
            ...
            <form class="col s12" action="../Controle/usuarioControle.php?function=updateFotoPerfil&id_usuario=<?php echo $_GET['id_usuario'] ?>" method="post"  enctype="multipart/form-data">
                <input type="file" class="file-chos" id="btnFile" name="arquivo" accept=".jpg,.jpeg,.bmp,.png,.jfif,.svg,.webp" hidden required="true">
