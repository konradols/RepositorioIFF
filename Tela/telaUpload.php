...
<main>
            ...
            <div class="">
                ...
                <div class="card center z-depth-4 col s12 l8 m10 offset-l2 offset-m1">
                    <div class="card-content">
                        ...
                        <form method="POST" id="formTrabalho"
                              action="../Controle/trabalhoControle.php?function=inserirTrabalho"
                              enctype="multipart/form-data">
                            <div class="row">
                                <div class="input-field col l6 s12">
                                    <textarea name="nome" id="nome" required="true"
                            ...
                            <div class="row">
                                <div class="input-field col l6 s12">
                                    <input type="text" name="autores" id="autores" required="true"
                                           placeholder="Autor1, Autor2, [...]">
                                    <label for="autores">Autores</label>
                                </div>
                                <div class="input-field col l6 s12">
                                    <input type="text" name="orientadores" id="orientadores" required="true"
                                           placeholder="Orientador1, Orientador2, [...]">
                                    <label for="orientadores">Orientadores(as)</label>
                                </div>
                                <div class="input-field col l6 s12">
                                    <input type="text" name="coorientadores" id="coorientadores"
    ...
    <script>
        ...
        var x = false;
        $("#formTrabalho").submit(function () {
            var dados = $(this).serialize();
            var esse = $(this);
            if(!x) {
                $.ajax({
                        url: "../Controle/usuarioControle.php?function=validasenha",
                        type: 'post',
                        data: dados,
